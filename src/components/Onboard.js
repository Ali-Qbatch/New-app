  ...
  render() {
    return (
      <Swiper
        ...
        autoplay={true}
        activeDotColor={'#098DCD'}
        showsButtons={false}>
        <View style={styles.slide1}>
          <First maxheight="100%" maxwidth="100%" />
          <Text style={styles.text}>Find New Items</Text>
        ...
        <View style={styles.slide1}>
          ...
          <Text style={styles.text}>Quick Reservation</Text>
          <Text style={styles.title}>
            Explore the items which are available only, No hassle.
          </Text>
          <Text
        ...
        <View style={styles.slide1}>
          ...
          <Text style={styles.text}>Quick Notification</Text>
          <Text style={styles.title}>
